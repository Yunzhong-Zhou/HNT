...
//            Glide.with(GuideActivity.this).load(imageUrlList.get(i)).fitCenter().into(imageView);//加载图片
        ...
        for (int i = 0; i < pageViews.size(); i++) {
            ...
            if (i == 0) {
                imageViews[i].setBackgroundResource(R.mipmap.ic_xuanzhong);
            } else {
                imageViews[i].setBackgroundResource(R.mipmap.ic_weixuan);
            }
...
//                    mIntent.setClass(GuideActivity.this, MainActivity.class);
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < imageViews.length; i++) {
                imageViews[position].setBackgroundResource(R.mipmap.ic_xuanzhong);
