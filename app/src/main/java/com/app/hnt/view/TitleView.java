...
//	}
    ...
    public void setBack(OnClickListener listener) {
        btn_left.setImageResource(R.mipmap.ic_return_black);
        if (listener != null) {
     ...
     * 显示右边的textview，并设置值
     */
    public void showRightTextview(String str, int resid, OnClickListener listener) {
        right_text.setVisibility(View.VISIBLE);
        btn_right.setVisibility(View.GONE);
        right_text.setText(str);
        ...
        right_text.setCompoundDrawables(drawable, null, null, null);
        right_text.setCompoundDrawablePadding(10);
...
//	}
    ...
    private OnClickListener mListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (mActivity != null) {
                mActivity.finish();
                mActivity.overridePendingTransition(R.anim.pop_enter_anim, R.anim.pop_exit_anim);
            }
        }
    };
