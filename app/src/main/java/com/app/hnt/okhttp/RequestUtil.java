...
class RequestUtil {
    ...
    private void getInstance() {
        if (mHeaderMap!=null){
            //        mHeaderMap.put("apikey", URLs.APIKEY);
//        mHeaderMap.put("hversion", URLs.HVERSION);
            mHeaderMap.put("Authorization", "bearer "+LocalUserInfo.getInstance(MyApplication.getContext()).getToken() );
        }
        /*if (mHeaderMap.isEmpty()) {
            mHeaderMap.put("uToken", LocalUserInfo.getInstance(MyApplication.getContext()).getToken());
        }*/
