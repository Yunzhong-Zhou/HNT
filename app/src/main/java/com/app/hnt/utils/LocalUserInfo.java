...
public class LocalUserInfo{
    ...
    public static final String Token = "uToken";//token
    ...
    public static final String USERHASH = "userHash";//用户hash
    ...
    public static final String DISTRICT = "District";//选择的区县
    ...
    public static final String ISSHOWJIFEN = "isShowJiFen";//是否显示积分
    public static final String LOSENUM = "loseNum";//未中奖信息

    public static final String ISNEWCOMER = "isNewcomer";//是否为新用户
    public static final String ISFROZE = "isFroze";//是否冻结
    ...
    //设置用户id
    public void setUserHash(String string) {
        editor.putString(USERHASH, string);
        editor.commit();
    }
    ...
    //是否SVIP
    public void setIsVip(String string) {
        editor.putString(ISVIP, string);
        editor.commit();
    }
    ...
    //设置是否冻结
    public void setIsFroze(String string) {
        editor.putString(ISFROZE, string);
        editor.commit();
    }

    public void setChatToken(String string) {
        editor.putString(CHATTOKEN, string);
        editor.commit();
    }
    ...
    public void setDistrict(String string) {
        editor.putString(DISTRICT, string);
        editor.commit();
    }
    ...
    //是否显示积分
    public void setIsshowjifen(String string) {
        editor.putString(ISSHOWJIFEN, string);
        editor.commit();
    }
...
//	}
    ...
    public String getUserHash() {
        String useid = getString(USERHASH);
        if (!TextUtils.isEmpty(useid)) {
            return useid;
        }
        return "";
    ...
    public String getChatToken() {
        String string = getString(CHATTOKEN);
        if (!TextUtils.isEmpty(string)) {
            return string;
        }
        return "";
    ...
    public String getDistrict() {
        String string = getString(DISTRICT);
        if (!TextUtils.isEmpty(string) && !"null".equals(string)) {
            return string;
        }
        return "";
...
//        return "39.906888";
    ...
    public String getIsshowjifen() {
        String string = getString(ISSHOWJIFEN);
        if (!TextUtils.isEmpty(string)) {
            return string;
        }
        return "1";
    ...
    public String getIsFroze() {
        String string = getString(ISFROZE);
        if (!TextUtils.isEmpty(string)) {
            return string;
        }
        return "";
    ...
    public boolean isLogin() {
        return !TextUtils.isEmpty(getString(USERHASH));
    }
}
